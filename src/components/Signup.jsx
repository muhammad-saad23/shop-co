        ...
        <form className="mt-8 space-y-6" action="" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-4 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <input id="name"  type="text" {...register("name",{required:{value:true,message:"Name field is required"}})} className="relative block w-full px-3 py-2 mt-1 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"/>
                ...
                <div>
                    ...
                    <div className="relative mt-1">
                              <input id="password" {...register("confirmPassword",{required:{value:true,message:"Please confirm your password"},validate:(password)=>password===pass || 'Password do not match'})} type={ConfirmPassword ? 'password' : 'text'} autoComplete="new-password"  className="relative block w-full px-3 py-2 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
                              <button type="button" onClick={ShowConfirmPassword} className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-500 cursor-pointer" >
                                {ConfirmPassword ? 
                                <IoMdEyeOff onClick={ShowConfirmPassword}/> 
                                : <IoMdEye onClick={ShowConfirmPassword}/> }                                
                              </button>
                        </div>
...
// export default function App({ShowConfirmPassword,ShowPassword}){
//     return(
//         <>
